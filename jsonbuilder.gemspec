...
Gem::Specification.new do |s|
  ...
  s.files = ["README", "ChangeLog", "Rakefile", "spec/builder", "spec/builder/hash_structure_spec.rb", "spec/builder/json_format_spec.rb", "spec/builder/xml_markup_spec.rb", "spec/jsonbuilder_spec.rb", "spec/spec_helper.rb", "lib/builder", "lib/builder/abstract.rb", "lib/builder/hash_structure.rb", "lib/builder/json_format.rb", "lib/builder/xml_markup.rb", "lib/jsonbuilder.rb"]
  s.has_rdoc = true
